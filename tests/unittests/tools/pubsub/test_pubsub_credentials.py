...
class TestPubSubCredentials:
  ...
  def test_pubsub_credentials_config_client_id_secret(self):
  ...
  def test_pubsub_credentials_config_existing_creds(self):
  ...
  def test_pubsub_credentials_config_oauth2_creds(self):
  ...
  def test_pubsub_credentials_config_validation_errors(self):
    ...
    with pytest.raises(ValueError):
      PubSubCredentialsConfig(client_id="abc")
